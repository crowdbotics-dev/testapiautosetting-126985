...
## Project Structure
    ...
    ├── testapiautosetting_126985  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_126985`
...
2. Clone this repo and `cd testapiautosetting_126985`
